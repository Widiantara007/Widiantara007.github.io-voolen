...
@section('content')
    ...
    <div class="container-fluid product py-5 my-5">
        <div class="container py-5">
            <div class="section-title text-center mx-auto wow fadeInU mb-5p" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-medium fst-italic text-primary">Our Activities</p>
                <h1 class="display-6">Variative activities to joined in Bali or online</h1>
            </div>
            <div class="container-fluid mt-5">
                <div class="row g-5">
                    <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                        <img class="img-fluid" src="img/article.png" alt="">
                    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
                        ...
                        <h1 class="display-6">Denpasar Creative Agency (BKRAF) : Resurging city's creative industry together with Volen Artspace</h1>
                    </div>
                    ...
                    <p class="mb-4">Today our teams is interviewing one of the leader of the city's creative movement, Hendar Agus, to hear about his perspectives in this industry, breaking down the paradigm of art & craft as economic aspect, and found the reasons why the agency was engaged Volen Artspace to its missions.</p>
                    {{-- <a href="" class="btn btn-dark rounded-pill py-3 px-5">Read More</a> --}}
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-lg-6 py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="py-5">
                        <h1 class="display-6 mb-4">Volen Artspace Empower <span class="text-white">Women</span> and Fight Against <span class="text-white">Mental Illness</span></h1>
                        <h5 class="fw-normal lh-base fst-italic text-white mb-5">Beyond good services & goods, we want to put values in our business. As feminists & crafters, our vission is strongly directed to empowering women in this island and help many women to coupe with their stress & depression in our activities, goods, & installation</h5>
                        <div class="row g-4 mb-5">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark">Open Minded</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark">Friendly</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark">All Ears</span>
                                </div>
                            </div>
                        </div>
                        <a  class="btn btn-dark rounded-pill py-3 px-5" href="">Join Now</a>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
    ...
    <div class="container-fluid testimonial py-5 my-5">
        <div class="container py-5">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6">What our clients say about Volen</h1>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
                <div class="testimonial-item p-4 p-lg-5">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="text-start ms-3">
                            <h5>Nula Curran</h5>
                            <span class="text-primary">Education Practiocioner</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-item p-4 p-lg-5">
                ...
                <div class="testimonial-item p-4 p-lg-5">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="text-start ms-3">
                            <h5>Gresia</h5>
                            <span class="text-primary">Mental Healt Enthusiast</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-medium fst-italic text-primary">Title Here</p>
               ...
               <div class="container margin-top">
                    <div class="clients-wrapper">
                        <ul class="client-thumb">
                            <li><a href="#"><img src="img/client_1.jpg" alt="Client 1"></a></li>
                            <li><a href="#"><img src="img/client_2.jpg" alt="Client 1"></a></li>
                            <li><a href="#"><img src="img/client_3.jpg" alt="Client 1"></a></li>
                            <li><a href="#"><img src="img/client_4.jpg" alt="Client 1"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid contact py-5 my-5">
        <div class="container ">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-3">Contact us right now</h1>
